...
df = df.dropna(subset=['rsi', 'ema', 'atr']).reset_index(drop=True)
...
print(df[['timestamp', 'bid_Close', 'rsi', 'ema', 'atr']].head(10))
print(f"Nombre de lignes avec RSI, EMA, ATR valides : {len(df)}")
